...
export default function ComponentWeb() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-white bg-cover bg-center bg-fixed">
      ...
      {/* Main Content */}
      <main className="max-w-full mx-24 p-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          {/* Solar System Orrery */}
          <div className="col-span-2 bg-gray-800 bg-opacity-90 p-4 rounded-lg">
          ...
          <div className="col-span-1 flex flex-col space-y-4 overflow-y-auto">
            ...
            <div className="bg-gray-800 flex-1 flex flex-col justify-between h-f bg-opacity-90 p-4 rounded-lg">
              <div>
              ...
              {products.map((product) => (
                <div key={product.id} className="bg-gray-700 p-2 rounded-lg flex items-center">
                  ...
                  <div className="flex flex-row gap-2">
                    <Button size="sm" className="px-8" onClick={() => buyWithMoney(product)}>
                      Buy
                    </Button>
